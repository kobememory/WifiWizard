    ...
    var WifiWizard = {
        ...
        getCurrentSSIDWithpermission: function(win, fail) {
            if (typeof win != "function") {
                console.log("getCurrentSSIDWithpermission first parameter must be a function to handle SSID.");
                return;
                }
            cordova.exec(win, fail, 'WifiWizard', 'getConnectedSSIDWithpermission', []);
        },
